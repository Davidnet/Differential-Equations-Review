...
\title{An Introduction to Differential Equations} % Book title
\author{\textit{David Cardozo}} % Author
\newcommand{\edition}{Private edition} % Book edition
...
\begin{document}
	...
	%Original: \ThisCenterWallPaper{1.12}{redblood.jpg}
	\ThisCenterWallPaper{1.30}{redblood.jpg} % Add the background image, the first argument is the scaling - adjust this as necessary so the image fits the entire page
